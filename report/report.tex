...
Les activités du Groupe OCP sont réparties sur plusieurs sites industriels et miniers à travers le Maroc. Cette implantation géographique permet d'assurer les différentes étapes de la chaîne de valeur du phosphate, depuis son extraction jusqu'à sa transformation.

Les principales activités d'extraction phosphatière sont réparties entre plusieurs bassins miniers, notamment Boucraâ-Laâyoune, Khouribga, Youssoufia et Benguerir. Ces sites assurent l'exploitation et l'extraction du phosphate destiné aux différentes étapes de valorisation.

La transformation et la valorisation chimique des phosphates sont principalement réalisées au niveau des plateformes industrielles de Safi et de Jorf Lasfar. Ces sites regroupent des installations dédiées à la transformation du phosphate en produits à plus forte valeur ajoutée, notamment les engrais et autres dérivés phosphatés.

Ainsi, la répartition des sites miniers et industriels permet au Groupe OCP de disposer d'une chaîne de production intégrée, reliant les zones d'extraction aux principales plateformes de transformation et de valorisation.
